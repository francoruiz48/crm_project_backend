...
from app.controllers.validation_rule_type_compatibility_controller import router as validation_rule_type_compatibilities_router
...
router.include_router(validation_rule_type_compatibilities_router)
